...
const StyleEditorModalComponent: React.FC<StyleEditorModalProps> = ({ isbn, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className={`relative bg-surface rounded-2xl shadow-2xl w-full h-[95vh] flex flex-col animate-in fade-in zoom-in duration-200 transition-all ${showPreview ? 'max-w-[1600px]' : 'max-w-3xl xl:max-w-7xl'}`} onClick={e => e.stopPropagation()}>
